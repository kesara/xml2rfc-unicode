...
<rfc ipr="trust200902" docName="draft-rathnayake-xml2rfc-unicode-01" category="exp" submissionType="independent" tocInclude="true" sortRefs="true" symRefs="true">
  <front>
...
DRAFT_TAIL = '''
  ...
  <back>
    <references>
      ...
      <reference anchor="blocks" target="https://www.unicode.org/Public/16.0.0/ucd/Blocks.txt">
        <front>
          <title>Blocks-16.0.0</title>
          <author>
      ...
      <reference anchor="charts" target="https://www.unicode.org/charts/">
        <front>
          <title>Unicode 16.0 Character Code Charts</title>
          <author>
            <organization>Unicode, Inc.</organization>
          </author>
          <date month="March" day="8" year="2023"/>
